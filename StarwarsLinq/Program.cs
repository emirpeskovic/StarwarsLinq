...
static IEnumerable<Planet> LoadData()
{
    var planets = new List<Planet>
    {
        ...
        new Planet
        {
            Name = "Rodia", Terrain = new List<string> { "jungles", "oceans", "urban", "swamps" }, RotationPeriod = 29,
            SurfaceWater = 60, Diameter = 7549, Population = 1300000000
        },
        new Planet
        {
            Name = "Nal Hutta", Terrain = new List<string> { "urban", "oceans", "bogs", "swamps" }, RotationPeriod = 87,
            Diameter = 12150, Population = 7000000000
        },
        new Planet
        {
        ...
        new Planet
        {
            Name = "Toydaria", Terrain = new List<string> { "swamps", "lakes" }, RotationPeriod = 21, Diameter = 7900,
            Population = 11000000
        },
        new Planet
        {
        ...
        new Planet
        {
            Name = "Dathomir", Terrain = new List<string> { "forests", "deserts", "savannas" }, RotationPeriod = 24,
            Diameter = 10480, Population = 5200
        },
        new Planet
        {
        ...
        new Planet
        {
            Name = "Vulpter", Terrain = new List<string> { "urban", "barren" }, RotationPeriod = 22, Diameter = 14900,
        ...
        new Planet
        {
            Name = "Champala", Terrain = new List<string> { "oceans", "rainforests", "plateaus" }, RotationPeriod = 27,
        ...
        new Planet
        {
            Name = "Hoth", Terrain = new List<string> { "tundra", "ice caves", "mountain ranges" }, RotationPeriod = 23,
            SurfaceWater = 100
        },
        new Planet
        {
            Name = "Dagobah", Terrain = new List<string> { "swamp", "jungles" }, RotationPeriod = 23, SurfaceWater = 8
        },
        new Planet
        {
        ...
        new Planet
        {
            Name = "Felucia", Terrain = new List<string> { "fungus", "forests" }, RotationPeriod = 34, Diameter = 9100,
            Population = 8500000
        },
        new Planet
        {
            Name = "Cato Neimoidia", Terrain = new List<string> { "mountains", "fields", "forests", "rock arches" },
            RotationPeriod = 25, Population = 10000000
        },
        new Planet
        {
...
var planets = LoadData().ToList();

// Opgave 1
var opg1 = planets.Where(p => p.Name.ToLower().StartsWith("m"));
Console.WriteLine("Opgave 1:");
foreach (var planet in opg1)
{
...
// Opgave 2
var opg2 = planets.Where(p => p.Name.ToLower().Contains('y'));
Console.WriteLine("Opgave 2:");
foreach (var planet in opg2)
{
    Console.WriteLine(planet.Name);
}
...
// Opgave 3
var opg3 = planets.Where(p => p.Name.Length is > 9 and < 15);
Console.WriteLine("Opgave 3:");
foreach (var planet in opg3)
{
    Console.WriteLine(planet.Name);
}
...
// Opgave 4
var opg4 = planets.Where(p => p.Name.Length > 1 && p.Name[1] == 'a');
Console.WriteLine("Opgave 4:");
foreach (var planet in opg4)
{
    Console.WriteLine(planet.Name);
}
...
// Opgave 5
var opg5 = planets.Where(p => p.RotationPeriod > 40).OrderBy(p => p.RotationPeriod);
Console.WriteLine("Opgave 5:");
foreach (var planet in opg5)
{
    Console.WriteLine(planet.Name);
}
...
// Opgave 6
var opg6 = planets.Where(p => p.RotationPeriod is > 10 and < 20).OrderBy(p => p.Name);
Console.WriteLine("Opgave 6:");
foreach (var planet in opg6)
{
    Console.WriteLine(planet.Name);
}
...
// Opgave 7
var opg7 = planets.Where(p => p.RotationPeriod > 30).OrderBy(p => p.Name).ThenBy(p => p.RotationPeriod);
Console.WriteLine("Opgave 7:");
foreach (var planet in opg7)
{
    Console.WriteLine(planet.Name);
}
...
// Opgave 8
var opg8 = planets.Where(p => p.RotationPeriod < 30 || p.SurfaceWater > 50)
    .Where(p => p.Name.ToLower().Contains("ba"))
    .OrderBy(p => p.Name)
    .ThenBy(p => p.SurfaceWater)
    .ThenBy(p => p.RotationPeriod);
Console.WriteLine("Opgave 8:");
foreach (var planet in opg8)
{
    Console.WriteLine(planet.Name);
}
...
// Opgave 9
var opg9 = planets.Where(p => p.SurfaceWater > 0).OrderByDescending(p => p.SurfaceWater);
Console.WriteLine("Opgave 9:");
foreach (var planet in opg9)
{
    Console.WriteLine(planet.Name);
}
...
// Opgave 11
var opg11 = planets.Except(planets.Where(p => p.RotationPeriod > 0));
Console.WriteLine("Opgave 11:");
foreach (var planet in opg11)
{
    Console.WriteLine(planet.Name);
}
...
// Opgave 15
var opg15 = planets.Where(p => Regex.IsMatch(p.Name, @"[aeiouy]{2}"));
Console.WriteLine("Opgave 15:");
foreach (var planet in opg15)
{
    Console.WriteLine(planet.Name);
}
...
// Opgave 16
var opg16 = planets.Where(p => Regex.IsMatch(p.Name, @"[klrn]{2}")).OrderByDescending(p => p.Name);
Console.WriteLine("Opgave 16:");
foreach (var planet in opg16)
{
    Console.WriteLine(planet.Name);
}